...
StockServices = (function() {
  ...
  StockServices.route = function(req, res, params) {
    var subroute;
    if (!params.api) {
      StockServices.outputError(res, "wrong api");
      return;
    }
    ...
    if (subroute) {
      if (StockServices[subroute[1]](params)) {
        ...
        return StockServices.outputError(res, "wrong parameters");
      }
    }
  };
  ...
  StockServices.outputError = function(res, message) {
    var result;
    result = {};
    result["status"] = "error";
  ...
  StockServices.get = function(res, params, url, callback) {
    return http.get(url, function(response) {
      ...
      return StockServices.outputError(res, e.message);
    });
  };
  ...
  StockServices.parseHistoryData = function(res, params, pageData) {
    ...
    return csv().from(pageData).transform(function(line) {
      ...
      return _this.outputError(res, e.message);
    });
  };
  ...
  StockServices.parseIfengFundsData = function(res, params, pageData) {
    ...
    length = $records.size();
    if (length <= 2) {
      this.outputError(res, e.message);
      return;
    }
